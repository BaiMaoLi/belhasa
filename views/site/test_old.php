...
<div style="width: 970px; margin: 10px auto;" id="arabicPrintPage">
    ...
    <div class="no-print">
        <button id = 'printCertificateLang' onClick="printCertificateLang()"><?php echo $result['page']['Print']; ?></button>
        <button id = 'printCertificate' onClick="printCertificate()"><?php echo $result['content']['Print']; ?></button>
        <button onClick="genPDF()" id='download'><?php echo $result['content']['download'];?></button>
        <button id = "close"><?php echo $result['content']['Close']; ?></button>
    </div>
</div>
